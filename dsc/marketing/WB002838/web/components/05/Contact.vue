<template>
    <div>
        <div id="contact" class="section">
            <div class="container">
                <p v-if="isMobile" class="title">
                    <i>鼎新HRM</i>與您攜手共度難關！
                    <br>從工時及工資爭議，幫你診斷並找出關鍵問題，從合法及系統完備，幫你梳理並避免爭議風險
                </p>
                <p v-else class="title">
                    <i>鼎新HRM</i>與您攜手共度難關！
                    <br>從工時及工資爭議，幫你診斷並找出關鍵問題
                    <br>從合法及系統完備，幫你梳理並避免爭議風險
                </p>
                    ...
                    <form>
                        ...
                        <div class="inforCheck">
                            <label for="demand01">
                                <input
                                    ...
                                    id="demand01"
                                    type="checkbox"
                                    value="我想完善公司內部控制，將人資運營效率化！索取HR解決方案相關資料。"
                                > 我想完善公司內部控制，將人資運營效率化！索取HR解決方案相關資料。
                            </label>
                        ...
                        <div class="basciInfo">
                            ...
                            <div class="outline">
                                ...
                                >
                                <p class="inputTitle">
                                    <span class="requiredHint">*</span>部門
                                    <i class="fa fa-exclamation-circle" aria-hidden="true"></i>
                                </p>
                            </div>
                            <div class="outline">
                                ...
                                >
                                <p class="inputTitle">
                                    <span class="requiredHint">*</span>職稱
                                    <i class="fa fa-exclamation-circle" aria-hidden="true"></i>
                                </p>
                            </div>
                            <div class="outline">
...
export default {
    ...
    mounted() {
        $.getScript(`${process.env.BASE_URL}public/vendor/eform/form.js`).done(function(){createCode()});
        $.getScript(`${process.env.BASE_URL}public/vendor/eform/contact.js`);
    },
}
</script>
...
#loading {
    ...
    p i {
        ...
        margin-bottom: 15px;
        height: 24px;
        background: url("/tw/dsc/images/Eform/loading.gif") no-repeat center
            center;
    }
}
/* #endregion loading */

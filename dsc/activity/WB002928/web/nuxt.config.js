// 部署路徑
let router = { path: 'activity/WB002928' };
...
module.exports = {
    ...
    */
    head: {
        meta: [
            ...
            { hid: 'description', name: 'description', content: '特別邀請富士康工業互聯網CEO 鄭弘孟 與陳冠棋副總裁、宇瞻科技智慧應用處 林志亮處長以及鼎新電腦 智能+研究中心 蘇斌雄專家' },
            { property: 'og:url', content: `http://www.digiwin.com${router.base}` },
            { property: 'og:type', content: 'website' },
            { property: 'og:title', content: '2019鼎新企業高峰年會(製造場)-企業數位化轉型 邁向台灣新智造' },
            { property: 'og:description', content: '特別邀請富士康工業互聯網CEO 鄭弘孟 與陳冠棋副總裁、宇瞻科技智慧應用處 林志亮處長以及鼎新電腦 智能+研究中心 蘇斌雄專家' },
    ...
    */
    ...
    env: {
        ...
        API_URL: router.base === '/' ? 'http://10.20.88.75:2928/' : `http://www.digiwin.com${router.base}`
    }
}

...
linkTo:function h(a){var b=this,c=a.url,d=a.target,e=a.anchor;if(d)window.open(''+c,d);else if(c&&!e)window.open(''+c,'_self'),this.setPageInfo(c);else if(!c&&e){var f=$(e).offset().top,g=$('.page-submenu').outerHeight();$('html, body').animate({scrollTop:f-g}),this.closeDropdownHandler()}else if(c&&e){window.open(''+c,'_self');var i=function(){if($(e).length){var a=$(e).offset().top,c=$('.page-submenu').outerHeight();return $('html, body').animate({scrollTop:a-c}),void b.closeDropdownHandler()}setTimeout(i,10)};i(),this.setPageInfo(c)}},// 設定頁面資訊

...
// let hash = '#contact';
// final
var a=location.pathname.split('/'),b=location.hash,c=a[a.length-2],d=a[a.length-1].replace(/(.html|.htm)/g,''),e=document.querySelector('.header-box header');null!==e&&new Vue({el:'#submenu',data:{results:[],currentPage:'',activeIndex:0,isActive:!1},computed:{submenu:function a(){return document.querySelector('.page-submenu')}},created:function a(){e.insertAdjacentHTML('beforeend','<div id="submenu"></div>')},mounted:function a(){this.getData()},beforeDestroy:function a(){window.removeEventListener('scroll',this.scrollHandler)},methods:{// 取得選單內容
getData:function b(){var a=this;fetch('/tw/dsc/assets/submenu/submenu.json').then(function(a){return a.json()}).then(function(b){a.results=b.filter(function(a){return a.id===c});a.results.length&&(// 依據選單高度設定main上方間距

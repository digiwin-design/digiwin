...
linkTo:function h(a){var b=this,c=a.url,d=a.target,e=a.anchor;if(d)window.open(''+c,d);else if(c&&!e)window.open(''+c,'_self'),this.setPageInfo(c);else if(!c&&e){var f=$(e).offset().top,g=$('.page-submenu').outerHeight();$('html, body').animate({scrollTop:f-g}),this.closeDropdownHandler()}else c&&e&&(window.open(''+c,'_self'),setTimeout(function(){var a=$(e).offset().top,c=$('.page-submenu').outerHeight();$('html, body').animate({scrollTop:a-c}),b.closeDropdownHandler()},100),this.setPageInfo(c))},// 設定頁面資訊

'use strict';function _defineProperty(a,b,c){return b in a?Object.defineProperty(a,b,{value:c,enumerable:!0,configurable:!0,writable:!0}):a[b]=c,a}(function(){var a,b=location.href.split('/'),c=b.find(function(a){return a.startsWith('WB')}),d='#/'+b[b.length-1].replace(/(.html|.htm)/g,''),e=document.querySelector('.header-box header');// dev
// let dir = '';
// let path = '/tw/dsc/solution/mobile/WB002839/index#/merchandise'.split('/');
// let hash = '';
// final
null===e||new Vue((a={el:'#submenu',data:{results:[],currentPage:'',activeIndex:0,isActive:!1},computed:{submenu:function a(){return document.querySelector('.page-submenu')}},beforeDestroy:function a(){window.removeEventListener('scroll',this.scrollHandler)},methods:{// 取得選單內容
getData:function b(){var a=this;fetch('/tw/dsc/assets/submenu-spa/submenu.json').then(function(a){return a.json()}).then(function(b){a.results=b.filter(function(a){return a.id===c});a.results.length&&(// 依據選單高度設定main上方間距
...
setActiveIndex:function b(){var a=this;this.results[0].menus.some(function(b,c){return b.url===d?(a.activeIndex=c,a.setCurrentPage(b.text),!0):void(b.dropdowns&&b.dropdowns.forEach(function(b){b.url===d&&(a.activeIndex=c,a.setCurrentPage(b.text))}))})},// 設定標題文字

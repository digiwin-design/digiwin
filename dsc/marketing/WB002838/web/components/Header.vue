    ...
    div.top
        ...
        #nav
            a(href='/tw', target='_blank')
                img.logo(src='//static.digiwin.com/tw/dsc/Library/images/logo.png', alt='鼎新官網', width='90', height='29')
            ul.link
                li.line_L
                    a(href='/tw/activity.html', target='_blank') 最新課程
                li
                    a(href='/tw/enewspaper.html', target='_blank') 電子報
                li
                    a(href='javascript:;')
                        | 解決方案
                        img(src='//static.digiwin.com/tw/dsc/Library/images/arr.png', width='9', height='7')
                    ul.subLink
                        li
                            a(href='/tw/case.html', target='_blank') E化案例
                li
                    ...
                    ul.subLink
                        ...
                        li
                            a(href='/tw/dsc/service/WB002588/WB00258801.html', target='_blank') 心服務新價值
                        li
                            a(href='https://a1.digiwin.com/', target='_blank') 商務應用雲
                        li
                            a(href='/tw/dsc/service/WB002903/web/WB00290301_index.htm', target='_blank') 鼎新服務雲
                li.Phone
                    a(href='/tw/contact/eform.html')
                        img(src='//static.digiwin.com/tw/dsc/Library/images/phoneIcon.png', width='16', height='12')
                        |  0800-888-162
</template>
...
export default {
    methods: {
        ...
        OPENOPEN() {
            this.$store.commit('toggleMask', !$('#nav').is(':visible'));

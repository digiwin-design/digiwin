<template>
    <div class="WB00247601_Industry05">
        ...
        <article class="section1">
            ...
            <slider :slides="result.WB00247601_Industry05.slider1">
                <swiper-slide v-for="slide in result.WB00247601_Industry05.slider1" :key="slide.id">
        ...
        <article class="section3">
            ...
            <slider :slides="result.WB00247601_Industry05.slider2">
                <swiper-slide v-for="slide in result.WB00247601_Industry05.slider2" :key="slide.id">
                    <div class="slide" :class="`slide${slide.id}`">
                        <h2>{{slide.title}}</h2>
                        <ul>

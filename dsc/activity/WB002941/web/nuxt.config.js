// 部署路徑
let router = { path: 'activity/WB002941' };
...
module.exports = {
    ...
    */
    head: {
        meta: [
            ...
            { hid: 'description', name: 'description', content: '透過創新商業模式促使企業數位化轉型，進而發掘客戶、銷售預測、提升良率來增速提效，助力企業掌握AI思維( Business AI Thinking)，預見智造未來！' },
            { property: 'og:url', content: `http://www.digiwin.com${router.base}` },
            { property: 'og:type', content: 'website' },
            { property: 'og:title', content: '製造AI：預見智造未來' },
            { property: 'og:description', content: '透過創新商業模式促使企業數位化轉型，進而發掘客戶、銷售預測、提升良率來增速提效，助力企業掌握AI思維( Business AI Thinking)，預見智造未來！' },
            { property: 'og:image', content: `http://www.digiwin.com${router.base}public/images/fb-share-v2.png` },
        ...
        script: [
            ...
            { src: 'https://cdnjs.cloudflare.com/ajax/libs/picturefill/3.0.2/picturefill.min.js', defer: 'defer' },
    ...
    */
    ...
    env: {
        ...
        API_URL: router.base === '/' ? 'http://10.20.88.75:2941/' : `http://www.digiwin.com${router.base}`
    }
}

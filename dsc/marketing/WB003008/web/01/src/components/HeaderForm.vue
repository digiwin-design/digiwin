    ...
    <div class="headForm">
        ...
        <ul class="headForm-fields">
            ...
            <li>
                ...
                <i v-if="!telephone">聯絡電話</i>
            </li>
        </ul>
        <a href @click.prevent="submit" class="headForm-submit">立即申請</a>
    </div>
</template>

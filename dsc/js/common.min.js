...
d&&'desktop'==c?location.replace(d.mobile):d&&'mobile'==c&&location.replace(d.desktop)})}(),function(){var a='www.digiwin.com'===location.hostname?'production':'no-production',b=location.pathname.split('/').pop().replace('.html','');document.querySelector('html').classList.add(a,b)}(),$(function(){var a=document.querySelector('#toolbar .p-2');if(a){var b=a.innerText.trim();document.querySelector('.xz-fudong a').setAttribute('href','tel:'+b)}}),$(function(){var a=location.pathname.replace(/(.html|.htm)$/,'');// 取得加入閱讀權限的文章

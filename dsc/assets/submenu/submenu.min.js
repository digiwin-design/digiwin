...
setActiveIndex:function c(){var a=this;this.results[0].menus.forEach(function(c,e){var f=c.url.replace(/(.html|.htm)/g,'');if(f===d||f===d+b)a.activeIndex=e,a.setCurrentPage(c.text);else if(c.dropdowns)return c.dropdowns.some(function(c){if(c.url===d+b)return a.activeIndex=e,a.setCurrentPage(c.text),!0})})},// 設定標題文字

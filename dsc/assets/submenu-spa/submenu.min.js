...
linkTo:function h(a){var b=this,c=a.url,d=a.target,e=a.anchor;if(d)window.open(''+c,d);else if(c&&!e)window.open(''+c,'_self'),this.setPageInfo(c);else if(!c&&e){var f=$(e).offset().top,g=$('.page-submenu').outerHeight();$('html, body').animate({scrollTop:f-g}),this.closeDropdownHandler()}else c&&e&&(// 切換頁面後延遲兩秒移動至錨點
